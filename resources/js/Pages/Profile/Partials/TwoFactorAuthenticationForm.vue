        ...
        <div v-if="qrCode">
          <div class="mt-4 max-w-xl font-semibold text-lg text-indigo-900 dark:text-sky-200">
            <p v-if="confirming" class="font-semibold">
                ...
                и предоставьте сгенерированный OTP код.
            </p>

            <p v-else>
                Теперь включена двухфакторная аутентификация.
                Отсканируйте следующий QR-код с помощью приложения для проверки подлинности вашего
                телефона или введите ключ настройки.
            </p>
          </div>
        ...
        <div v-if="recoveryCodes.length > 0 && !confirming">
          <div class="mt-4 max-w-xl text-lg text-indigo-900 dark:text-sky-200">
            <p class="font-semibold">
                ...
                в случае утери устройства двухфакторной аутентификации.
            </p>
          </div>

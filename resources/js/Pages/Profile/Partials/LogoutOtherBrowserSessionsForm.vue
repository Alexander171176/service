...
<template>
  <ActionSection>
    <template #title> Сессия Браузера </template>

    <template #description>
        Управляйте своими активными сессиями и выходите из них в других браузерах и устройствах.
    </template>
    ...
    <template #content>
      ...
      <div class="flex items-center mt-5">
        <PrimaryButton @click="confirmLogout"> Выйти из других сессий браузера </PrimaryButton>

        <ActionMessage :on="form.recentlySuccessful" class="ms-3"> Сделано. </ActionMessage>
      </div>

      <!-- Log Out Other Devices Confirmation Modal -->
      <DialogModal :show="confirmingLogout" @close="closeModal">
        <template #title> Выйти из других сессий браузера </template>

        <template #content>
            Пожалуйста, введите свой пароль, чтобы подтвердить, что вы хотите выйти из другой сессии браузера

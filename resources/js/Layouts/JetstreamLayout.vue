                        ...
                        >
                          ...
                          />
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            <!-- Team Management -->
                                            <div class="block px-4 py-2 text-xs text-gray-400">Управление Группы</div>
                                            ...
                                            <template v-if="$page.props.auth.user.all_teams.length > 1">
                                                ...
                                                <div class="block px-4 py-2 text-xs text-gray-400">Переключение Группы</div>
                      ...
                      >
                        ...
                        >
                          ...
                          />
                                    ...
                                    <template #content>
                                        <!-- Account Management -->
                                        <div class="block px-4 py-2 text-xs text-gray-400">Управление Аккаунтом</div>
